...
public class TitleBarBlack extends RelativeLayout
{
	...
	public TitleBarBlack(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
		initView(context);
	}

	public TitleBarBlack(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initView(context);
	}

	public TitleBarBlack(Context context)
	{
		super(context);
		initView(context);
	}
	...
	public ImageView getImageRight2()
	{
		return vIvRight2;
	}
