...
import talex.zsw.basetool.crash.caoc.CaocConfig;
import talex.zsw.basetool.crash.cockroach.Cockroach;
import talex.zsw.basetool.interfaces.OnSimpleListener;
...
public class Tool
{
	 ...
	 */
	public static void init(Context context, boolean isDebug, boolean isMulitProcess)
	{
