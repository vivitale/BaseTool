package talex.zsw.basetool.view.other.swipetoloadlayout.header;
...
import talex.zsw.basetool.util.DeviceTool;
import talex.zsw.basetool.view.other.swipetoloadlayout.SwipeRefreshTrigger;
import talex.zsw.basetool.view.other.swipetoloadlayout.SwipeTrigger;
import talex.zsw.basetool.view.other.swipetoloadlayout.drawable.yalantis.BaseRefreshDrawable;
import talex.zsw.basetool.view.other.swipetoloadlayout.drawable.yalantis.SunRefreshDrawable;
